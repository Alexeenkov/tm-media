...
<html lang="ru">
    ...
    <body>
        <div class="block_success">					
            <h2 style="text-transform: uppercase;">Спасибо за заявку!</h2>
            <p class="success">
                В ближайшее время с вами свяжется менеджер для подтверждения заказа. Пожалуйста, включите ваш контактный телефон.
            </p>
            <h3 class="success">
            ...
            <div class="success">
                <ul class="list_info">
                    ...
                    <li><span>Телефон: </span><span id="name"><?php echo isset($_GET['name']) ? $_GET['name'] : '' ;?></span></li>
                    <li><span>Телефон: </span><span id="tel"><?php echo isset($_GET['phone']) ? $_GET['phone'] : '' ;?></span></li>
